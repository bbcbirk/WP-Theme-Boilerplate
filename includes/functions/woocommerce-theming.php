...
class [THEME_PASCALCASED]WoocommerceTheming {
	...
	/* Restructure html to fit [THEMENAME] structure and layout */
	public static function reorder_layout() {
		...
		*/
		add_action( 'woocommerce_before_main_content', [ __CLASS__, '[THEME_UNDERSCORED]_woo_wrapper_start' ], 10 );
		add_action( 'woocommerce_after_main_content', [ __CLASS__, '[THEME_UNDERSCORED]_woo_wrapper_end' ], 10 );
		add_action( 'woocommerce_sidebar', [ __CLASS__, '[THEME_UNDERSCORED]_woo_content_main_wrapper_end' ], 10 );
	...
	public static function [THEME_UNDERSCORED]_woo_wrapper_start() {
		echo '<div class="content-main"><main>';
	}

	public static function [THEME_UNDERSCORED]_woo_wrapper_end() {
		echo '</main>';
	}

	public static function [THEME_UNDERSCORED]_woo_content_main_wrapper_end() {
		echo '</div>';
	}
...
$[THEME_UNDERSCORED]_woocommerce_theming = [THEME_PASCALCASED]WoocommerceTheming::instance();
