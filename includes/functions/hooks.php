	...
	$new_schemas = [
		...
		'post-featured' => [
			[
				...
				'srcset' => [
					[
						'size'       => '[THEME_KEBAB]-post-featured-xl',
						'descriptor' => 'w',
						'value'      => 1440,
					],
				],
			...
			[
				...
				'srcset' => [
					[
						'size'       => '[THEME_KEBAB]-post-featured-l',
						'descriptor' => 'w',
						'value'      => 1040,
					],
				],
			...
			[
				...
				'srcset' => [
					[
						'size'       => '[THEME_KEBAB]-post-featured-m',
						'descriptor' => 'w',
						'value'      => 720,
					],
				],
			...
			[
				'srcset' => [
					[
						'size'       => '[THEME_KEBAB]-post-featured-s',
						'descriptor' => 'w',
						'value'      => 400,
					],
				],
...
add_filter( '[THEME_UNDERSCORED]_picture_sources', __NAMESPACE__ . '\add_srcset_schemas' );
