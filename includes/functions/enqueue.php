...
function enqueue() {
	...
	// Load theme styles
	wp_register_style( '[THEME_KEBAB]-css-base', get_template_directory_uri() . '/assets/dist/css/base' . $inflix . '.css', $base_css_deps, $theme_info['version'], 'all' );
	wp_enqueue_style( '[THEME_KEBAB]-css-base' );

	// Scripts file and settings in the footer
	wp_register_script( '[THEME_KEBAB]-js-base', get_template_directory_uri() . '/assets/dist/js/base' . $inflix . '.js', $base_js_deps, $theme_info['version'], true );
	wp_enqueue_script( '[THEME_KEBAB]-js-base' );
...
function admin_enqueue() {
	...
	wp_enqueue_style( '[THEME_KEBAB]-css-base-admin', get_template_directory_uri() . '/assets/dist/css/base-admin' . $inflix . '.css', [], $theme_info['version'], 'all' );

	// Scripts file and settings in the footer
	wp_enqueue_script( '[THEME_KEBAB]-js-base-admin', get_template_directory_uri() . '/assets/dist/js/base-admin' . $inflix . '.js', [], $theme_info['version'], true );
}
...
function login_enqueue() {
	...
	wp_register_style( '[THEME_KEBAB]-css-base-login', get_template_directory_uri() . '/assets/dist/css/base-login' . $inflix . '.css', [], $theme_info['version'], 'all' );

	wp_enqueue_style( '[THEME_KEBAB]-css-base-login' );
}
