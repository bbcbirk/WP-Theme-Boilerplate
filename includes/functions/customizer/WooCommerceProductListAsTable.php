...
use [THEME_PASCALCASED]\Theme\Abstracts\CustomizerBase;
...
class WooCommerceProductListAsTable {
	...
	public static function is_active() {
		...
		$active = apply_filters( '[THEME_UNDERSCORED]_woocommerce_product_list_as_table__active', $active );
		return $active;
	}
	...
	public static function layout_switch() {
		...
		$layout = apply_filters( '[THEME_UNDERSCORED]_woocommerce_product_list_as_table__layout', $layout );
		switch ( $layout ) {
			case 'test':
				# code...
				break;
			case 'default':
			default:
				if ( ! has_action( '[THEME_UNDERSCORED]_woocommerce_product_list_as_table__custom_layout' ) ) {
					self::layout_default();
				}
				break;
		}

		do_action( '[THEME_UNDERSCORED]_woocommerce_product_list_as_table__custom_layout', $layout );
	}
