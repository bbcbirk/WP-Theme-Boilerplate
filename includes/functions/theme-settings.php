...
class ThemeSettings {
	...
	public function customize_css() {
		...
		$handle = '[THEME_KEBAB]-css-theme-settings';
		\[THEME_PASCALCASED]\Theme\add_inline_css( $css, $handle );
	}
	...
	public function add_global_js_vars() {
		...
		wp_register_script( '[THEME_KEBAB]-js-theme-settings', false );
		wp_enqueue_script( '[THEME_KEBAB]-js-theme-settings' );
		wp_localize_script( '[THEME_KEBAB]-js-theme-settings', '[THEME_CAMELCASED]Settings', apply_filters( THEMEDOMAIN . '_js_theme_settings', $theme_settings ) );
	}
