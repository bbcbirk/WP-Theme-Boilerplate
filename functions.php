...
if ( ! defined( 'THEMEDOMAIN' ) ) {
	define( 'THEMEDOMAIN', '[THEME_UNDERSCORED]' );
}
...
function image_sizes() {
	...
	add_image_size( '[THEME_KEBAB]-small', 300, 169, true );             // 16/9 small
	add_image_size( '[THEME_KEBAB]-medium', 575, 324, true );            // 16/9 medium
	add_image_size( '[THEME_KEBAB]-large', 800, 450, true );             // 16/9 large
	add_image_size( '[THEME_KEBAB]-xlarge', 1190, 669, true );           // 16/9 xlarge
	add_image_size( '[THEME_KEBAB]-post-archive', 360, 360, true );      // Post archive
	add_image_size( '[THEME_KEBAB]-hero-s', 400, 314, true );            // Hero <picture>
	add_image_size( '[THEME_KEBAB]-hero-m', 720, 314, true );            // Hero <picture>
	add_image_size( '[THEME_KEBAB]-hero-l', 1040, 314, true );           // Hero <picture>
	add_image_size( '[THEME_KEBAB]-hero-xl', 1440, 314, true );          // Hero <picture>
	add_image_size( '[THEME_KEBAB]-post-featured-s', 400, 205, true );   // Post featured <picture>
	add_image_size( '[THEME_KEBAB]-post-featured-m', 720, 400, true );   // Post featured <picture>
	add_image_size( '[THEME_KEBAB]-post-featured-l', 1040, 570, true );  // Post featured <picture>
	add_image_size( '[THEME_KEBAB]-post-featured-xl', 1190, 650, true ); // Post featured <picture>
}
